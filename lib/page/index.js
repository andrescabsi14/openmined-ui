...
var defaultImage = 'https://s3.amazonaws.com/openmined.org/images/logo.png';
var defaultFacebookImage = 'https://s3.amazonaws.com/openmined.org/images/logo-facebook.png';
var defaultTwitterImage = 'https://s3.amazonaws.com/openmined.org/images/logo-twitter.png';
...
var Page = function (_React$Component) {
  ...
  _createClass(Page, [{
    ...
    value: function getMetaTags(_ref, pathname) {
      ...
      var theFacebookImage = image ? image : defaultFacebookImage;
      var theTwitterImage = image ? image : defaultTwitterImage;

      var metaTags = [{ itemprop: 'name', content: theTitle }, { itemprop: 'description', content: theDescription }, { itemprop: 'image', content: theImage }, { name: 'description', content: theDescription }, { name: 'twitter:card', content: 'summary_large_image' }, { name: 'twitter:site', content: defaultTwitter }, { name: 'twitter:title', content: theTitle }, { name: 'twitter:description', content: theDescription }, { name: 'twitter:creator', content: twitter || defaultTwitter }, { name: 'twitter:image:src', content: theTwitterImage }, { property: 'og:title', content: theTitle }, { property: 'og:type', content: contentType || 'website' }, { property: 'og:url', content: defaultUrl + pathname }, { property: 'og:image', content: theFacebookImage }, { property: 'og:description', content: theDescription }, { property: 'og:site_name', content: defaultTitle }, { property: 'fb:app_id', content: '308339039653695' }];
